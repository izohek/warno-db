...
const AllUnitCards: UnitCardRawData[] = [
    ...
    [249, 'FV432', 'trans'],
    [250, '81MM MORTAR', 'art'],
    [251, 'CHALLENGER 1 MK1', 'tank'],
    [252, 'TRACKED RAPIER', 'aa'],
    [253, 'LYNX AH MK1', 'trans'],
    [254, 'FERRET MK2', 'rec'],
    [255, 'FV433 ABBOT', 'art'],
    [256, 'FV105 SULTAN', 'log'],
    [257, 'FV103 SPARTAN', 'trans'],
    [258, 'FV101 SCORPION', 'rec'],
    [259, 'FH70 155MM', 'art'],
    ...
    [1092, 'BEDFORD Mk.4t', 'trans'],
    [1093, 'CHALLENGER 1 MK1', 'tank'], // CMD TANK
    [1094, 'JAVELIN LML', 'aa'],
    [1095, 'ASSAULT PIONIERS (CARL. G)', 'inf'],
    [1096, 'ASSAULT PIONIERS LDR.', 'inf'],
    [1097, 'ASSAULT PIONIERS', 'inf'],
    [1098, 'FV120 SPARTAN MCT', 'trans'],
    [1099, 'CENTURION MK.5 AVRE', 'tank'],
    [1100, 'CHIEFTAIN MK. 11 CMD', 'tank'],
    [1101, 'CHIEFTAIN MK. 11', 'tank'],
    [1102, 'CHIEFTAIN MK. 9', 'tank'],

    [1103, 'FV432 COMMAND', 'log'],
    [1104, 'FV438 SWINGFIRE', 'tank'],
    [1105, 'GUN GROUP', 'inf'],
    [1106, 'SAS PATROL', 'rec'],
    [1107, 'ROVER CP', 'log'],
    [1108, 'ROVER', 'trans'],
    [1109, 'JAVELIN', 'aa'],
    [1110, 'FV510 WARRIOR MILAN', 'trans'],
    [1111, 'RIFLES', 'inf'],
    [1112, 'RIFLES LDR.', 'inf'],
    [1113, 'SCOUTS (LAW-80)', 'rec'],
    [1114, 'SCOUTS', 'rec'],

    [1116, 'VBL MILAN', 'rec'],
    [1117, 'VBL RECO', 'rec'],
    [1118, 'CHINOOK HC.1 SUPPLY', 'log'],
    [1119, 'GAZELLE AH.1 [RKT]', 'hel'],
    [1120, 'GAZELLE LBH.1', 'trans'],
    [1121, 'LYNX AH.1 HELARM', 'hel'],
    [1122, 'LYNX AH.7 HELARM', 'hel'],
    [1123, 'HARRIER GR.3 [CLU]', 'air'],
